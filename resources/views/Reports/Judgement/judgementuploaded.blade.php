...
<script src="js/buttons.print.min.js"></script>
 ...
 <section class="content" style="width: 75%">
  <div class="panel  panel-primary">
   <form name="form1" id="form1" action="datajudgmentuploaded" method="post">
    {{ csrf_field() }}
<div class="col-md-10">
<table class="table no-margin table-bordered">

    <tr>
    <td  class="bg-primary text-center" colspan="4"> <h4>List of Judgement Uploaded </h4> </td>
    </tr>
...
<tr>
  <td>     <label>Status<span class="mandatory">*</span></label></td>
  <td>
    <div class="form-group">

      <select class="form-control" name="applTypeName" id="applTypeName"  data-parsley-required data-parsley-required-message="Select Status" >
        <option value="">Select Status</option>
         <option value="-1" >All</option>
         <option value="not NULL" >Verifed</option>
         <option value="NULL" >Not Verifed</option>
