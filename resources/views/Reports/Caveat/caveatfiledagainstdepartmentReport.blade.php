    ...
    var establishfullname="<?php echo $establishmentname; ?> "
      jq(document).ready(function () {
               ...
               jq('#myTable').dataTable({
                ...
                dom: 'Bfrtip',
                  buttons: [
            { extend: 'copy',messageTop: 'List of Caveat filed against Department from '+fromdate+' to '+  todate,title:establishfullname,footer: true,header:true,pageSize : 'LEGAL',orientation : 'landscape'},
            { extend: 'excel', messageTop: 'List of Caveat filed against Department from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true ,pageSize : 'LEGAL',orientation : 'landscape'},
            { extend: 'csv', messageTop: 'List of Caveat filed against Department from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,pageSize : 'LEGAL',orientation : 'landscape'},
            { extend: 'pdf', messageTop: 'List of Caveat filed against Department from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,pageSize : 'LEGAL',orientation : 'landscape'},
            { extend: 'print', messageTop: 'List of Caveat filed against Department from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,pageSize : 'LEGAL',orientation : 'landscape'}
    ...
    <table class="table table-bordered table2 display" data-page-length='25' id="myTable" width="100%">
        <thead>
          ...
          <td  class="bg-primary text-center" colspan="10"> <h3>  <?php echo $establishmentname; ?></h3> </td>
            ...
            <tr>
          <td  class="bg-primary text-center" colspan="10"> <h4> List of Caveat filed against Department from <?php echo   date('d/m/Y', strtotime($fromdate)) ?> to <?php echo   date('d/m/Y', strtotime($todate)) ?>  </h4> </td>
          </tr>
...
<td>Caveatee Name</td>
    ...
    <tbody>
           ...
           <tr>
            ...
            $caveateedeptname=$result1->caveateedeptname;
            $caveateename=$result1->caveateename;
             ...
             <td align="center">{{$i++}}</td>
              ...
              <td><?php echo $caveateedeptname; ?></td>
              <td><?php echo $caveateename; ?></td>
