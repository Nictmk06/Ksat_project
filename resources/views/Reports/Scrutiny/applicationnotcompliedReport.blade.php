        ...
        var establishfullname="<?php echo $establishmentname; ?> "
             jq(document).ready(function () {
                ...
                jq('#myTable').dataTable({
                    ...
                    dom: 'Bfrtip',
                      buttons: [
                { extend: 'copy',messageTop: 'Application not complied objections '+fromdate+' to '+  todate,title: establishfullname,footer: true,header:true},
                { extend: 'excel', messageTop: 'Application not complied objections '+fromdate+' to '+  todate,title:establishfullname, footer: true,header:true },
                { extend: 'csv', messageTop: 'Application not complied objections '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true },
                { extend: 'pdf', messageTop: 'Application not complied objections '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true},
                { extend: 'print', messageTop: 'Application not complied objections '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true}
  ...
  <div class="panel  panel-primary">
    ...
    <table class="table table-bordered table2 display"  data-page-length='25' id="myTable" width="100%">
        <thead>
          ...
          <tr>
          <td  class="bg-primary text-center" colspan="8"> <h4>  Application not complied objections <?php echo   date('d/m/Y', strtotime($fromdate)) ?> to <?php echo   date('d/m/Y', strtotime($todate)) ?> </h4> </td>
          </tr>
...
<td>Rejected On</td>
<td>Last Date for Compliance </td>
</tr>
...
<?php $sum=0;?>
           ...
           <tr>
            ...
            $tobecomplieddate=$result1->tobecomplieddate;
         ?>
             <td align="center">{{$i++}}</td>
               ...
               <td><?php echo date('d/m/Y', strtotime( $tobecomplieddate)); ?></td>
