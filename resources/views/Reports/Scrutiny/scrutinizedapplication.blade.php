...
<script src="js/buttons.print.min.js"></script>
 ...
 <section class="content" style="width: 75%">
  <div class="panel  panel-primary">
   <form name="form1" id="form1" action="datascrutinized" method="post">
    {{ csrf_field() }}
<div class="col-md-10">
<table class="table no-margin table-bordered">

    <tr>
    <td  class="bg-primary text-center" colspan="4"> <h4>List of scrutinized application </h4> </td>
    </tr>
...
<tr>
  <td>     <label>Scrutiny Status<span class="mandatory">*</span></label></td>
  <td>
    <div class="form-group">

      <select class="form-control" name="status" id="status"  data-parsley-required data-parsley-required-message="Select Connected Application Type" >
