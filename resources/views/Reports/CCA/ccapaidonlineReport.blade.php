    ...
    <table class="table table-bordered table2 display" data-page-length='25' id="myTable" width="100%">
        <thead>
          ...
          <td  class="bg-primary text-center" colspan="12"> <h3>  <?php echo $establishmentname; ?></h3> </td>
            ...
            <tr>
          <td  class="bg-primary text-center" colspan="12"> <h4> CCA Online Payment Report from <?php echo   date('d/m/Y', strtotime($fromdate)) ?> to <?php echo   date('d/m/Y', strtotime($todate)) ?></h4> </td>
          </tr>
          <td  class="bg-primary text-center" colspan="12"> <h4> Total amount paid <?php echo $total; ?> </h4> </td>
          </tr>
...
<tr>
  ...
  <td> Bank Transaction No</td>
   ...
   <tr>
            ...
            <td>{{$result1->applicationid}}</td>
            <td>{{$result1->ccaapplicationno}}</td>
            <td>{{$result1->caapplicationdate1}}</td>
            <td>{{$result1->caapplicantname}}</td>
            <td>{{$result1->totamount}}</td>
            <td>{{$result1->receiptamount}}</td>
            <td>{{$result1->challan_ref_no}}</td>
            <td>{{$result1->bank_transaction_no}}</td>
