    ...
    var establishfullname="<?php echo $establishmentname; ?> "
      jq(document).ready(function () {
               ...
               jq('#myTable').dataTable({
                ...
                dom: 'Bfrtip',
                  buttons: [
            { extend: 'copy',messageTop: 'CCA deficit Report from '+fromdate+' to '+  todate ,title:establishfullname,footer: true,header:true,pageSize : 'LEGAL',orientation : 'landscape'},
            { extend: 'excel', messageTop: 'CCA deficit Report from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,pageSize : 'LEGAL',orientation : 'landscape' },
            { extend: 'csv', messageTop: 'CCA deficit Report from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true ,pageSize : 'LEGAL',orientation : 'landscape'},
            { extend: 'pdf', messageTop: 'CCA deficit Report from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,pageSize : 'LEGAL',orientation : 'landscape'},
            { extend: 'print', messageTop: 'CCA deficit Report from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,pageSize : 'LEGAL',orientation : 'landscape'}
    ...
    <table class="table table-bordered table2 display" data-page-length='25' id="myTable" width="100%">
        <thead>
          ...
          <td  class="bg-primary text-center" colspan="12"> <h3>  <?php echo $establishmentname; ?></h3> </td>
            ...
            <tr>
          <td  class="bg-primary text-center" colspan="12"> <h4> CCA deficit Report from <?php echo   date('d/m/Y', strtotime($fromdate)) ?> to <?php echo   date('d/m/Y', strtotime($todate)) ?></h4> </td>
          </tr>
...
<tr>
  ...
  <td>Deficit Notified Date</td>
  <td>Deficit Receipt Date</td>
</tr>
  ...
  <?php $sum=0;?>
           ...
           $applicationid=$result1->applicationid;
            ...
            $damount=$result1->damount;
            $deficitnotifieddate=$result1->deficitnotifieddate;
            $deficitreceiptdate=$result1->deficitreceiptdate;
            $sum=$sum+$damount;
          ...
          ?>
             <td align="center">{{$i++}}</td>
              ...
              <?php echo "<td>".($deficitnotifieddate ? date('d/m/Y', strtotime($deficitnotifieddate)) : '')."</td>";?>
              <?php echo "<td>".($deficitreceiptdate ? date('d/m/Y', strtotime($deficitreceiptdate)) : '')."</td>";?>
             ...
             <td></td>
              <td></td>
                <td></td>
                 ...
                 <td></td>
                 <td></td>
                 <td align="right">Total Deficit Amount</td>
