...
<script src="js/buttons.print.min.js"></script>
 ...
 <section class="content" style="width: 75%">
  <div class="panel  panel-primary">
   <form name="form1" id="form1" action="dataapplicationwihfee" method="post">
    {{ csrf_field() }}
<div class="col-md-10">
<table class="table no-margin table-bordered">

    <tr>
    <td  class="bg-primary text-center" colspan="4"> <h4>  Application With Fee OR Receipt Details </h4> </td>
    </tr>
