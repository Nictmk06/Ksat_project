        ...
        var establishfullname="<?php echo $establishmentname; ?> "
             jq(document).ready(function () {
                ...
                jq('#myTable').dataTable({
                    ...
                    dom: 'Bfrtip',
                      buttons: [
                { extend: 'copy',messageTop: ' List of Incomplete Applications ',title: establishfullname,footer: true,header:true},
                { extend: 'excel', messageTop: ' List of Incomplete Applications',title:establishfullname, footer: true,header:true },
                { extend: 'csv', messageTop: ' List of Incomplete Applications',title: establishfullname, footer: true,header:true },
                { extend: 'pdf', messageTop: ' List of Incomplete Applications',title: establishfullname, footer: true,header:true},
                { extend: 'print', messageTop: ' List of Incomplete Applications',title: establishfullname, footer: true,header:true}
  ...
  <div class="panel  panel-primary">
    ...
    <table class="table table-bordered table2 display"  data-page-length='25' id="myTable" width="100%">
        <thead>
          ...
          <tr>
          <td  class="bg-primary text-center" colspan="9"> <h4>  List of Incomplete Applications   </h4> </td>
          </tr>
...
<td>Number of Respondant </td>
<td>Entered Applicant</td>
<td>Entered Respondant </td>
</tr>
...
<?php $sum=0;?>
         ...
         //   $establishmentname=$result1->establishname;
			...
			$appcount=$result1->appcount;
            $rescount=$result1->rescount;
         ?>
