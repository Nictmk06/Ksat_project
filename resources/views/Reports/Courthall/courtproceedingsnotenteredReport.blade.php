    ...
    var establishfullname="<?php echo $establishmentname; ?> "
      jq(document).ready(function () {
               ...
               jq('#myTable').dataTable({
                ...
                dom: 'Bfrtip',
                  buttons: [
            { extend: 'copy',messageTop: 'Court Proceedings not entered from '+fromdate+' to '+  todate,title:establishfullname,footer: true,header:true,orientation : 'landscape'},
            { extend: 'excel', messageTop: 'Court Proceedings not entered from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,orientation : 'landscape' },
            { extend: 'csv', messageTop: 'Court Proceedings not entered from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,orientation : 'landscape'},
            { extend: 'pdf', messageTop: 'Court Proceedings not entered from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,orientation : 'landscape'},
            { extend: 'print', messageTop: 'Court Proceedings not entered from '+fromdate+' to '+  todate,title: establishfullname, footer: true,header:true,orientation : 'landscape'}
    ...
    <table class="table table-bordered table2 display" data-page-length='25' id="myTable" width="100%">
        <thead>
          ...
          <td  class="bg-primary text-center" colspan="10"> <h3>  <?php echo $establishmentname; ?></h3> </td>
            ...
            <tr>
          <td  class="bg-primary text-center" colspan="10"> <h4>  Court Proceedings not entered from <?php echo   date('d/m/Y', strtotime($fromdate)) ?> to <?php echo   date('d/m/Y', strtotime($todate)) ?>  </h4> </td>
          </tr>
...
<td>Hearing Date</td>
<td>Bench Name</td>
<td>Courthall Name</td>
<td>List No</td>
<td>Purpose Name</td>
<td>Causelist Serial No</td>
...
<td>Dictation By</td>
    ...
    <tbody>
           ...
           <tr>
            ...
            $courthalldesc=$result1->courthalldesc;
            $listno=$result1->listno;
            $listpurpose=$result1->listpurpose;
            $causelistsrno=$result1->causelistsrno;
            $applicationid=$result1->applicationid;
              $dictationby=$result1->dictationby;
             ...
             <td align="center">{{$i++}}</td>
              ...
              <td><?php echo $judgeshortname; ?></td>
              <td><?php echo $courthalldesc; ?></td>
             <td><?php echo $listno; ?></td>
             <td><?php echo $listpurpose; ?></td>
