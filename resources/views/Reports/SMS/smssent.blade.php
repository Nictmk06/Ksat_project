...
<script src="js/buttons.print.min.js"></script>-->
 ...
 <section class="content" style="width: 75%">
  <div class="panel  panel-primary">
   <form name="form1" id="form1" action="datasmssent" method="post">
    {{ csrf_field() }}
<div class="col-md-10">
<table class="table no-margin table-bordered">

    <tr>
    <td  class="bg-primary text-center" colspan="4"> <h4>  List of SMS sent </h4> </td>
    </tr>
...
<tr>
  <td>     <label>Module<span class="mandatory">*</span></label></td>
  <td>
    <div class="form-group">

      <select class="form-control" name="module" id="module"  data-parsley-required data-parsley-required-message="Select Module" >
...
<tr>
  <td>     <label>Message sent to ?<span class="mandatory">*</span></label></td>
  <td>
    <div class="form-group">

      <select class="form-control" name="applTypeName" id="applTypeName"  data-parsley-required data-parsley-required-message="Select  SMS sent  to?" >
        <option value="" disabled>Select</option>
        <option value="-1" >ALL</option>

         <option value="Y">Advocate</option>
        <option value="N">Non-Advocate</option>
