        ...
        var establishfullname="<?php echo $establishmentname; ?> "
             jq(document).ready(function () {
                ...
                jq('#myTable').dataTable({
                    ...
                    dom: 'Bfrtip',
                      buttons: [
                { extend: 'copy',messageTop: 'For '+modulename+' '+subtitle, title: establishfullname,footer: true,header:true},
                { extend: 'excel', messageTop: 'For '+modulename+' '+ subtitle, title:establishfullname, footer: true,header:true },
                { extend: 'csv', messageTop:'For '+modulename+' '+subtitle, title: establishfullname, footer: true,header:true },
                { extend: 'pdf', messageTop:'For '+modulename+' '+subtitle, title: establishfullname, footer: true,header:true},
                { extend: 'print', messageTop:'For '+modulename+' '+subtitle, title: establishfullname, footer: true,header:true}
  ...
  <div class="panel  panel-primary">
    ...
    <table class="table table-bordered table2 display"  data-page-length='25' id="myTable" width="100%">
        <thead>
          ...
          <tr>
          <td  class="bg-primary text-center" colspan="8"> <h4> For <?php echo $modulename; ?>   <?php echo  $subtitle ?> </h4> </td>
          </tr>
...
<td>Mobile no</td>
    ...
    <tbody>
           ...
           <tr>
            ...
            $smscontent=$result1->smscontent;
            $sentondate=$result1->sentondate;
            $modulename=$result1->modulename;
            $deliverystatus=$result1->deliverystatus;
            $smspreparedate=$result1->smspreparedate;
            $mobileno=$result1->mobileno;
             ...
             <td align="center">{{$i++}}</td>
               ...
               <td><?php echo date('d/m/Y', strtotime($sentondate)); ?></td>

               <td><?php echo $modulename; ?></td>
               <td><?php echo $deliverystatus; ?></td>
               <td><?php echo date('d/m/Y', strtotime($smspreparedate)); ?></td>
