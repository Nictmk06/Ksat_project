...
<div class="content-wrapper">
  ...
  @include('flash-message')
   ...
   <!-- <form role="form" id="ccApplicationForm" method="POST" action="saveCCApplication" data-parsley-validate>-->
    	...
    	<form role="form" id="ccabyemail" action="{{ action('CCAControllerbyemail@facesheetdownload_1') }}"  method="POST"
	data-parsley-validate>
			  @csrf
			<div class="panel  panel-primary">
			  <div class="panel panel-heading">
				<h7 >Offline Generate FaceSheet</h7>
			  </div>
...
<button name="printfacesheet" class="btn btn-primary" type="submit"  value="<?php echo $cca->applicationid.'-'.$cca->ccaapplicationno;?>">Generate Facing Sheet</button>
