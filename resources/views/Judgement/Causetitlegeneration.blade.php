...
.grid-item {
  ...
  <section class="content">
    ...
    <form role="form" id="causetitlegenerationform"  method="POST" action="Causetitlegenerate" data-parsley-validate>
      @csrf

     <div class="panel  panel-primary">
      <div class="panel panel-heading origndiv">
        <h7 >Cause Title Generation</h7>
      </div>
	 ...
	 <div class="row divstyle"  style="float: middle;" id="add_apl_div">
		<div  class="col-sm-10 text-center">
		  <button type="submit" class="btn btn-primary" Style="width: 150px;" >View Causetitle </button>
...
<script src="js/judgement/causetitlegeneration.js"></script>
