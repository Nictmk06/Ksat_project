...
<!--   <form action="savejudgements" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
   ...
   <form role="form" id="uploadJudgementsForm" action="savejudgements" enctype="multipart/form-data" method="POST"
			 ...
			 <div class="col-md-4">
              <div class="form-group">
                <label>Upload Judgement</label><span class="mandatory">*</span>
                  <input type="file" id="judgement" name="judgement">
                 </div>
                  <div id="element"></div>
            </div>
          </div>
    ...
    <script src="js/judgement/uploadjudgements.js"></script>
  </section>
