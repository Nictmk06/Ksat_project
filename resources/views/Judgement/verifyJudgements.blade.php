...
<div class="content-wrapper">
   ...
   input[type=checkbox]
 {
  ...
  <section class="content">
   ...
   <form role="form" id="verifyJudgementsForm" action="DownloadJudgements"  method="POST"
      ...
      <div class="panel  panel-primary">
        ...
        <div class="row"  style="float: right;" id="add_apl_div">
		   ...
		   <div class="col-sm-12 text-center">
                <button type="button" id="VerifyJudgement" class="btn btn-primary">Verify Judgement</button>
