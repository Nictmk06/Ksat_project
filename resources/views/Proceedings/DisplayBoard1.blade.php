  ...
  <div class="container">
     <div class="top_layer">
      ...
      <table id="ch1table" class="table no-margin table-bordered" cellpadding="10"style="font-size:300%;">
       <tr class='display_row1' style="font-size:120%;background-color:#212240">
        <td > Court Hall - I </td>
         <td id="ch1a"> </td>
         </tr>
       <!--   <tr class='display_row' >
          ...
          <tr class='display_row' style="background-color:#29658a">
          <td style="width: 40%"> Passed Over  </td>
            <td id="ch1p"> </td>
         </tr>

     </table>
           <table id="ch2table" class="table no-margin table-bordered" style="font-size:300%;">
        <tr class='display_row1'  style="font-size:120%;background-color:#212240"">
           <td > Court Hall - II </td>
           <td id="ch2a"></td>
         </tr>
      ...
      <table id="ch3table" class="table no-margin table-bordered"  cellpadding="10"  style="font-size:300%;">
        <tr class='display_row1' style="font-size:120%;background-color:#212240" >
