...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div>
     <form role="form" id="freshApplicationForm" method="POST" action="saveFreshApplication1" data-parsley-validate>
      @csrf
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="applTypeName" id="applTypeName" data-parsley-required data-parsley-required-message="Select Application Type" data-parsley-trigger='change'>
                        ...
                        @foreach($applicationType as $applType)
                        <option value="{{$applType->appltypecode.'-'.$applType->appltypeshort.'-'.$applType->applfees.'-'.$applType->referflag}}">{{$applType->appltypedesc.'-'.$applType->appltypeshort}}</option>
                        @endforeach
                      </select>
    ...
    @endif
      ...
      <script src="js/application/application1.js"></script>
    </section>
    @endsection
