...
<table  width='100%'><thead><tr><td align='left'><font size='1'><b>Website: </b></font></td><td align='center'><font size='1'><b>Page {PAGENO} of {nb}</b></font></td><td align='right'><font size='1'><b> NIC,KSU  </b></font></td></tr></thead></table>
...
<table class='items' border='0' width='100%' style='font-size: 12.5pt;'>
	...
	<tr>
		<td colspan='3'  style='font-size: 14pt;' align='center'>
		  ...
		  for ($i=0;$i<$benchjudge[0]->judgescount;$i++)
			 { echo($benchjudge[$i]->judgename);echo('.....'); echo($benchjudge[$i]->judgedesigname); echo '<br>'; }
		   }  }
		?>
          </b>
		</td>
 ...
 <tr style='height:1px;'><td colspan=3><hr></td></tr> -->
    ...
    <tr style='height:1px; text-align:left;'>
	    <td colspan='3' style='font-size: 14pt;'><b> {{ $causelist[0]->clheader }}  </b> 
		</td>
	</tr>
