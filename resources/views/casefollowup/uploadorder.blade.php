...
<!--   <form action="savejudgements" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
   ...
   <form role="form" id="uploadOrderForm" action="saveorder" enctype="multipart/form-data" method="POST"
      ...
      <div class="panel  panel-primary">
        ...
        <div class="panel panel-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
			 ...
			 <div class="col-md-4">
                      ...
                      <div class="input-group date">
						...
						value=""  data-parsley-pattern="/^[0-9_-]+$/" data-parsley-pattern-message="Order Date Allows only digits"
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>Bench Name<span class="mandatory">*</span></label>
                <select class="form-control" name="benchname" id="benchname" data-parsley-trigger='change'  data-parsley-required data-parsley-required-message="Select Bench Name"  >
            ...
            <div class="col-md-4">
              ...
              <select class="form-control" name="ordertype" id="ordertype"  data-parsley-trigger='change'  data-parsley-required data-parsley-required-message="Select Order Type">
          ...
          <div class="row">
              <div class="col-md-4">
              <div class="form-group">
                <label>Upload Order</label><span class="mandatory">*</span>
                  <input type="file" id="uploadorder" name="uploadorder">
                 </div>
                  <div id="element"></div>
            </div>
          </div>
    ...
    <script src="js/order/orderupload.js"></script>
