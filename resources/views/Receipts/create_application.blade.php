...
<div class="content-wrapper">
	...
	<br>
	<div class="container">
		<form role="form" id="receiptForm" action="receiptCrudStoreWtApp" method="POST" data-parsley-validate>
			@csrf
			<div class="row">
				<div class="col-md-10">
					<table class="table no-margin table-bordered">
						...
						<tr>
							<td> <span class="mandatory">*</span><label>Type of Application</label></td>
							<td> 
							...
							<td> <span class="mandatory">*</span> <label>Application No<label></td>
							<td>
								<div class="input-group date">
								<input type="text" name="application_no" class="form-control pull-right" id="application_no" value="" required>
						...
						<tr>
							<td><span class="mandatory">*</span> <label>Party Details </label> </td>
							<td colspan="3">
								<span id="partydetails"></span>
							</td>
						</tr>
						...
						<tr>
							<td colspan="4">
								<div class="text-center">
										...
										<button type="submit" name="saveButton" id="saveButton" class="btn btn-primary" disabled> Save </button>
...
$("#editSearch").click(function(){
		...
		var applId = newtype[1]+'/'+$("#application_no").val();
		
	    $.ajax({
				type: 'post',
				dataType:'JSON',
				url: 'getApplicationDetailsFreshApplicationReceipt',
				...
				success: function(data) {
					...
					else
					{
						...
						$('#partydetails').html(data.Applicant[0].applicantname+' <span style="color:red;font-weight:bold;">V/S</span> '+data.Respondant[0].respondname);
