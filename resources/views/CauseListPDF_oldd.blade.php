...
<thead>
	<tr>
	<td align='left'><font size='1'><b>Website:https://ksat.karnataka.gov.in/ </b></font></td>
	<td align='center'><font size='1'><b>Generated on : {{ date('d-m-Y H:i:s') }} </b></font></td>
	<td align='right'><font size='1'><b>Page {PAGENO} of {nb} </b></font></td></tr></thead></table>
...
<table class='items' border='0' width='100%' style='font-size: 12.5pt;'>
  <tr> 
		...
		<br>
<?php
//  if($title[0]->establishcode=='2' || $title[0]->establishcode=='3' )
//  { $msg='<br><b>  FOR  PHYSICAL HEARING<br><b></b>';
//   print_r($msg);
//}
//$Todaydatee = date("d-m-Y H:i:s");
//$Todaydate =strtotime($Todaydatee);
//$PhysicalHearingNewHeadingDate = strtotime('21-12-2020 00:00:00');

//if ($date >= $PhysicalHearingNewHeadingDate ) {
// if($title[0]->establishcode=='2' || $title[0]->establishcode=='3' )
// { $msg='<br><b>  FOR  PHYSICAL HEARING<br><b></b>';
//  print_r($msg);
//  }
...
<tr style='height:1px; '>
     <td colspan='3'  style='font-size: 14pt;text-align:center;'> <b><?php  echo nl2br($causelist[0]->clnote); echo '<br>';
             ?></b>
   </td>
 </tr>
 ...
 <!--  <tr>
  ...
  <tr><td  style="padding: 10px">
    ...
    <tr>
        ...
        <td style='width:45%;' valign='top'  align='left'> {{$causelist[$i]->applicationid}} <br>
...
<table border='0' width='100%' style='font-size: 12pt;'>
 <tr style='height:1px; '>
 	    <td colspan='3'  style='font-size: 12pt;text-align:center;'> <?php  echo nl2br($causelist[0]->clfooter); echo '<br>';
              ?>
 		</td>
 	</tr>
 	</table>
...
<tr style='height:1px; '>
            <td colspan='3'  style='font-size: 14pt;'> <?php  echo nl2br($causelist[0]->clfooter); echo '<br>';
             ?>
                </td>
        </tr>
