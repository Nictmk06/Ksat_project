...
<div class="content-wrapper">
  ...
  <div id="appends" style="display: none">@extends('case/caseData')</div>
    ...
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
          <form role="form" id="caseForm" action="{{route('caseDataStore')}}" data-parsley-validate>
            <div class="panel  panel-primary">
              <div class="panel panel-heading">Details of Application</h7>
              </div>
              <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="applTypeName" id="applTypeName" data-parsley-required data-parsley-required-message="Select Application Type" data-parsley-trigger='change'>
                        ...
                        <option value="{{$applType->appltypecode.'-'.$applType->appltypeshort.'-'.$applType->feerequired.'-'.$applType->referflag}}">{{$applType->appltypedesc.'-'.$applType->appltypeshort}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Application Year:<span class="mandatory">*</span></label>
                        <input type="text" name="applYear"  class="form-control pull-right"  id="applYear" data-parsley-date-format="YYYY" readonly data-parsley-trigger='keypress' >
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" data-parsley-pattern="/^[0-9]+$/" placeholder="Application Start No" maxlength="6"  class="form-control pull-right zero number" id="applStartNo" name="applStartNo"
                      data-parsley-required  data-parsley-required-message="Enter Application Start No" data-parsley-trigger='keypress' onblur="setendapp()">
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" data-parsley-pattern="/^[0-9]+$/" placeholder="Application End No" maxlength="6"  name="applEndNo" id="applEndNo" class="form-control zero number"
                      data-parsley-pattern="/^[0-9]+$/"
                      data-parsley-required  data-parsley-required-message="Enter Application End No" data-parsley-trigger='keypress'>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control number zero" name="noOfAppl" id="noOfAppl" type="text" data-parsley-pattern="/^[0-9]+$/" placeholder="Applicant No" maxlength="2"  id="noOfAppl" value="" data-parsley-required data-parsley-required-message="Enter No fo Applicants" data-parsley-minlength="1" data-parsley-minlength-message="No of Applicants Should have minimum 1 digit" data-parsley-maxlength="6" data-parsley-maxlength-message="No of Applicants Should have maximum 6 digit" data-parsley-trigger='keypress' >
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
					  ...
					  <input class="form-control number zero" name="noOfRes" type="text" data-parsley-pattern="/^[0-9]+$/" placeholder="Respondant No" maxlength="2" id="noOfRes"  value="" data-parsley-required data-parsley-required-message="Enter No of Respondants" data-parsley-minlength="1" data-parsley-minlength-message="No of Respondants Should have minimum 1 digit" data-parsley-maxlength="6" data-parsley-maxlength-message="No of Respondants Should have maximum 6 digit" data-parsley-trigger='keypress'>
                    </div>
                  </div>
                </div>
                <div class="row">
                    ...
                    <div class="panel-body">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Pincode</label>
							<input class="form-control zero number" name="rPincode" placeholder="Pincode" maxlength="6"  type="text" id="rPincode" onkeyup="this.value=this.value.replace(/[^0-9]$/,'')"  onblur="maxLengthCheck(this,6,6)">
                          </div>
                        </div>
						<div class="col-md-4">
                          <div class="form-group">
      ...
      </div>  <form  id="receiptForm" action="{{ route('receiptDataStore') }}" data-parsley-validate>
      <div class="panel panel-primary">
        <input name="_token" id="token" type="hidden" value="{{ csrf_token() }}"/>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="hidden" name="receiptSrno" id="receiptSrno">
				 <input type="hidden" id="establishcode" name="establishcode" value={{$establishcode}} >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="receiptDate" class="form-control pull-right datepicker" id="receiptDate" data-parsley-required data-parsley-required-message="Enter Receipt Date." data-parsley-errors-container="#error1" data-parsley-trigger='keypress'>
                </div>
                <span id="error1"></span>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control number zero" name="recpAmount" type="number" id="recpAmount" data-parsley-required data-parsley-required-message="Enter Receipt Amount"  data-parsley-minlength="2"  data-parsley-minlength-message="Receipt Amount Should have Minimum 2 Digits" data-parsley-maxlength='6' data-parsley-maxlength-message="Receipt Amount Accepts only 6 digits" data-parsley-trigger='keypress'>
              </div>
            </div>
            <div class="col-md-4">
  ...
  <div class="tab-pane" id="tab_3">
    <div class="panel panel-primary">
      ...
      <div class="panel panel-body">
        <form role="form" id="applicantForm" action="{{ route('applicantDataStore') }}" data-parsley-validate>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                data-parsley-required  data-parsley-required-message="Enter Age" data-parsley-required  data-parsley-required-message="Enter Age"
          ...
          <div class="row">
            ...
            <div class="col-md-4 advDetails">
              <!-- <div class="form-group">
                ...
                <input list="browsers"  class="form-control number zero" name="advBarRegNo" type="text" id="advBarRegNo" data-parsley-required data-parsley-required-message="Enter Advocate Bar Reg No."  data-parsley-pattern="/([a-zA-Z]{3})\/([0-9]{1,6})\/([0-9]{4})/" data-parsley-pattern-message="Please Enter Advocate Reg No in Correct Format">
  ...
  <div class="tab-pane" id="tab_4">
    <div class="panel panel-primary">
      ...
      <div class="panel panel-body">
        <form role="form" id="respondantForm" action="{{ route('respondantDataStore') }}" data-parsley-validate>
          <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
          ...
          <input class="form-control" name="resadvcode" type="hidden" id="resadvcode" >
  ...
  <div class="tab-pane" id="tab_5">
    <div class="panel panel-primary">
      ...
      <div class="panel panel-body">
        <form role="form" id="ApplIndexForm" action="{{ route('applicationIndexDataStore') }}" data-parsley-validate>
          <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
      ...
      <div class="row">
        ...
        <div class="col-sm-10 text-center" style="float: right;">
          <input type="hidden" name="applIndex_up_value" id="applIndex_up_value" value='A'>
