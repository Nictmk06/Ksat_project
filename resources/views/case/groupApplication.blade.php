...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" id="groupdateForm" action="groupDataStore" data-parsley-validate>
        ...
        <div class="panel  panel-primary">
          ...
          <div class="panel panel-body">
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label>Additional Start No<span class="mandatory">*</span></label>

                  <input type="text" name="additionalstno" class="form-control pull-right number zero" id="additionalstno" value=""  data-parsley-required data-parsley-error-message='Enter Application No' data-parsley-pattern='^[0-9/ ]+$' data-parsley-pattern-message='Invalid Application No' maxlength='20'>
                </div>
              </div>
                <div class="col-md-4">
                <div class="form-group">
                  <label>Additional End No<span class="mandatory">*</span></label>

                  <input type="text" name="additionalendno" class="form-control pull-right number zero" id="additionalendno" value=""  data-parsley-required data-parsley-error-message='Enter Application No' data-parsley-pattern='^[0-9/ ]+$' data-parsley-pattern-message='Invalid Application No' maxlength='20'>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" name="additionalDate" class="form-control pull-right datepicker" id="additionalDate" value=""  data-parsley-trigger='keypress' data-parsley-errors-container="#error20" data-parsley-required-message="Enter  Date" data-parsley-required>
                  </div>
