...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" id="causelistfinalize"  method="POST" data-parsley-validate action="printcauselist" target="_blank"  >


    <div class="panel  panel-primary">

      <div class="panel panel-heading origndiv">
        <h7 >Finalize Causelist</h7>
      </div>
...
-->
  ...
  <input type="button" id="save" class="btn btn-primary btnSearch  btn-md center-block" Style="width: 100px;float: right; " value="Finalize ">
...
$("#save").click(function(e){
      e.preventDefault();
    swal({
        title: "Changes will not be allowed. Want to finalize the causelist?",
        icon: "warning",
