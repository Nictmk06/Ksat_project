...
.grid-item {
  ...
  <section class="content">
    ...
    <form role="form" id="movecauselistform"  method="POST" action="moveCauseListSave" data-parsley-validate>
      @csrf

     <div class="panel  panel-primary">
      <div class="panel panel-heading origndiv">
        <h7 >Move Causelist</h7>
      </div>
    ...
    <div class="col-md-4">
	  ...
	  <div class="row divstyle"  style="float: center;" id="add_apl_div">
		<div class="col-sm-12 text-center">
		 ...
		 <input type="submit" id="movecauselist" class="btn btn-primary btnSearch  btn-md center-block" Style="width: 100px;" value="Move">
...
<script src="js/casemanagement/movecauselist.js"></script>
