...
class ReceiptController extends Controller
{
    ...
    public function receiptclosedtget(Request $request)
    {
        ...
        $accClosingDt = DB::select("select distinct receiptdate FROM public.receipt  where receiptdate > :receiptdate order by receiptdate  limit 1",['receiptdate' => $prevclosedt]);
