...
<form id="myForm" id="myForm" action="saveScrutinyCompliance" method="POST" data-parsley-validate>
@csrf
<div class="row">
<div class="col-md-12">
	  <table class="table no-margin table-bordered">
        ...
        <tr>
        <td  class="bg-primary text-center" colspan="4"> <h4> Scrutiny Compliance  </h4> </td>
        </tr>
</table>
     ...
     <table class="table no-margin table-bordered">
       ...
       <tr>
        ...
        <div class="text-center">
          ...
          <a class="btn btn-primary"  Style="width: 100px;" href="scrutinyCompliance"> Back </a>
        </div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
     ...
     <!--<button type="button" class="btn btn-danger" id="deleteAllSelectedRecords">Delete Selected</button> -->
      ...
      <input type="checkbox" name="ids1[]" style="opacity:0; position:absolute;" class="checkBoxClass1" value="{{$scrutinydetails->chklistsrno}}"   />
