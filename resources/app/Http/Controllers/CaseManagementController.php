 ...
 public function extrarespondantStore(Request $request)
    {
      ...
      // print_r($repondantStore);
        ...
        if($sbmt_respondant=='A')
        {
          ...
          $value = DB::transaction(function () use($application_id,$repondantStore) {
...
//echo $applicantStore['applicantsrno'];
     ...
     //   echo ('raj '.$sbmt_applicant);
        ...
        if($sbmt_applicant=='A')
        {  
          $value = DB::transaction(function () use($application_id,$applicantStore) {
...
//print_r($applicantStore);
    ...
    public function applIndexStore(Request $request)
    {
       $sbmt_index = $request->input('applIndex_up_value');
        ...
        else
        {
             ...
             $flag='application';
            $app['application'] = $this->case->getAllApplicationDetails($application_id,$user,$flag);
    ...
    public function ApplicantSerialDetails()
    {
        $newSrno = $_POST['newSrno'];
        $applicationid = $_POST['applicationid'];
    ...
    public function ApplicationDetails(Request $request)
    {
       ...
       $data['ApplicationDet'] = $this->case->getAllApplicationDetails($application_id,$user,$flag);
   ...
   public function ApplicationDetailsCauseList(Request $request)
      {
         ...
         $data['ApplicationDet'] = $this->case->getApplicationDetailsCauseList($application_id,$user,$flag);
         echo json_encode($data['ApplicationDet']);
      }
