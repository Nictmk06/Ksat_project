...
//require(dirname(__DIR__) .'/FPDI/src/fpdi.php');
//use FPDI\src\fpdi;
...
class WatermarkPDF extends FPDI {
    ...
    function Header() {
		...
		$this->SetFont('courier', '', 60);
        $this->SetTextColor(232,232,232);
        $this->RotatedText(20, 230, $this->rotatedText, 90);
        $this->RotatedText(180, 230, $this->rotatedText, 90);
    }
