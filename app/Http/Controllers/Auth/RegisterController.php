...
class RegisterController extends Controller
{
    ...
    */
    ...
    { 
       ...
       // $data['userDetails'] = DB::select("select * from userdetails where enableuser ='Yes' or enableuser is null and establishcode = $establishcode order by userid");
     $data['userDetails'] = DB::table('userdetails')->select('*','establishment.establishname')
			->Join('establishment', 'establishment.establishcode', '=', 'userdetails.establishcode')->orderby('userid')->get();
