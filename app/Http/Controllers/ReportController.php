...
public static function table_names()
{
  ...
  $t_name = DB::select("SELECT '=======================> Table <=======================' as t_name,'' as tab
union
SELECT table_name as t_name,'T' as Tab FROM information_schema.tables
WHERE table_type='BASE TABLE' AND table_schema='public'
UNION
select '=======================> View <=======================' as t_name,'U' as tab
UNION
SELECT table_name as t_name,'V' as Tab from INFORMATION_SCHEMA.views
WHERE table_schema  = ANY (current_schemas(false))  order by tab,t_name");
  //$t_name = DB::select("SELECT table_name as t_name from INFORMATION_SCHEMA.views WHERE table_schema  = ANY (current_schemas(false)) order by t_name");
