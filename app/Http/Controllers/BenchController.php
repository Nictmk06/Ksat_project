...
class BenchController extends Controller{
	...
	public function index(Request $request)
    {
        ...
        $data['jdesig'] = $this->bench->getJudgeDesignation();
         $data['jdesig2'] = $this->bench->getJudgeDesignation();
	...
	{       
		 $request->validate([
			...
			if ($request->benchtypename=='1')
				{
					...
					$count_1 = DB::table('bench')->where('judgeshortname','=',$jsname1)->where('display','=','Y')->where('establishcode','=',$request->session()->get('EstablishCode'))->count();
					...
					$useractivitydtls['applicationid_receiptno'] = $bcode;
					$useractivitydtls['createdon'] = date('Y-m-d H:i:s') ;
					$useractivitydtls['activity'] ='Bench creation' ;
			...
			elseif($request->benchtypename=='2'){
						...
						$count_1 = DB::table('bench')->where('judgeshortname','=',$judgeshortname)->where('display','=','Y')->where('establishcode','=',$request->session()->get('EstablishCode'))->count();
						$count_2 = DB::table('bench')->where('judgeshortname','=',$judgeshortname1)->where('display','=','Y')->where('establishcode','=',$request->session()->get('EstablishCode'))->count();
