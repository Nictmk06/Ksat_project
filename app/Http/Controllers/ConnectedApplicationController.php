...
//        $data['usermenumodule'] = $this->module->usermenumodule($request->session()->get('userName'));
        ...
        {*/
          ...
          $type1 = explode('-',$request->get('applTypeName'));
           ...
           $Connected = new ConnectedModel([
            ...
            'conapplyear' => $request->get('conapplyear')
            ]);
                ...
                else
                {
                 ...
                 // $Connected->applicationid =$request->get('conaplid');
                    ...
                    $Connected->orderno=$request->get('orderNo');
				   	...
				   	$useractivitydtls['applicationid_receiptno'] = $request->get('orignapplid');
					$useractivitydtls['createdon'] = date('Y-m-d H:i:s') ;
					$useractivitydtls['activity'] ='Add Connect Application' ;
    ...
    public function getConStatusdetails(Request $request)
    {
	 $request->validate([
		'applicationid' => array(
						'required',
